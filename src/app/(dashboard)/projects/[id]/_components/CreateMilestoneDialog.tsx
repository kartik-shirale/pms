...
export function CreateMilestoneDialog({
    ...
    const defaultProjectId = projectInstances[0]?.id;
    ...
    const selectedProjectId = form.watch("projectInstanceId");
    ...
    useEffect(() => {
        if (open && selectedProjectId) {
            Promise.all([
                ...
                getProjectDepartmentMembers(selectedProjectId),
    ...
    const onSubmit = async (data: MilestoneFormData) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                onOpenChange(false);
                form.reset({ projectInstanceId: defaultProjectId });
                onMilestoneCreated();
            } else {
